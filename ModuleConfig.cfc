...
component {
	...
	this.entryPoint			= "";
	// Model Namespace
	this.modelNamespace		= "formutilities";
	// CF Mapping
	this.cfmapping			= "formutilities";
	// Module Dependencies
	this.dependencies 		= [];
	...
	function configure(){
		...
		interceptors = [
			{ class="#moduleMapping#.interceptors.FormUtilities", name="FormUtilities@FormUtilities" }
		];
